/**
 * Arquivo: 1da273617537d909d830b9e56b139af4.js
 * Objetivo: Lógica de interação do site.
 * Boas práticas aplicadas:
 *  - Comentários JSDoc em funções nomeadas
 *  - Organização e espaçamento consistente
 *  - Evitar alterações de comportamento (sem renomear identificadores)
 */
...
if (!window.HTMLPictureElement && document.addEventListener) {
    window.addEventListener("DOMContentLiteSpeedLoaded", function() {
        ...
        s.src = "https://allvaleesquadrias.com/wp-content/plugins/webp-express/js/picturefill.min.js";
...
const events = ['DOMContentLiteSpeedLoaded', 'elementor/lazyload/observe', ];
...
var elementorFrontendConfig = {
    ...
    "experimentalFeatures": {
        ...
        "e_element_cache": !0,
        "home_screen": !0,
        "global_classes_should_enforce_capabilities": !0,
        "e_variables": !0,
        "cloud-library": !0,
        "e_opt_in_v4_page": !0,
        "mega-menu": !0
    ...
    "urls": {
        "assets": "https:\/\/allvaleesquadrias.com\/wp-content\/plugins\/elementor\/assets\/",
        "ajaxurl": "https:\/\/allvaleesquadrias.com\/wp-admin\/admin-ajax.php",
        "uploadUrl": "https:\/\/allvaleesquadrias.com\/wp-content\/uploads"
    },
    "nonces": {
        "floatingButtonsClickTracking": "f7168241b0"
    },
    "swiperClass": "swiper",
    "settings": {
        "page": [],
    ...
    "post": {
        "id": 9,
        "title": "In%C3%ADcio%20-%20Allvale",
        "excerpt": "",
        "featuredImage": !1
    }
}; /*! elementor - v3.31.0 - 11-08-2025 */
...
! function(m, y, e, o) {
    ...
    function X(e, t) {
        var o = b["on" + e];
        o && ("function" == typeof o ? o.call(t[0]) : (o.addClass && t.addClass(o.addClass), o.removeClass && t.removeClass(o.removeClass))), t.trigger("lazy" + e, [t]), u()
    }
    ...
    function i(e) {
        if (T.length) {
            e = e || b.forceLoad, L = 1 / 0;
            for (var t = I(), o = y.innerHeight || C.clientHeight, n = y.innerWidth || C.clientWidth, a = 0, r = T.length; a < r; a++) {
                var i, l, s, d, c, u, f = T[a],
                    h = f[0],
                    v = f[p],
                    A = !1,
                    g = e || E(h, w) < 0;
                m.contains(C, h) ? (e || !v.visibleOnly || h.offsetWidth || h.offsetHeight) && (g || (i = h.getBoundingClientRect(), l = v.edgeX, s = v.edgeY, g = (d = i.top + t - s - o) <= t && i.bottom > -s && i.left <= n + l && i.right > -l), g ? (f.on(z, B), X("show", f), (u = "function" == typeof(c = v.srcAttr) ? c(f) : h.getAttribute(c)) && (h.src = u), A = !0) : d < L && (L = d)) : A = !0, A && (T.splice(a--, 1), r--)
            }
            r || X("complete", m(C))
        }
    }
    ...
    function l() {
        1 < r ? (r = 1, i(), setTimeout(l, b.throttle)) : r = 0
    }

    function u(e) {
        T.length && (e && "scroll" === e.type && e.currentTarget === y && L >= I() || (r || setTimeout(l, 0), r = 2))
    }
    ...
    m[p] = d(b, n, m[p]), m.fn[p] = function(a) {
        var e, r = c(a = a || {}, "blankImage"),
            ...
            l = c(a, "show"),
            s = {};
        for (e in m(t).on("scroll", u), n) s[e] = c(a, e);
        return this.each(function(e, t) {
            if (t === y) m(b.selector).lazyLoadXT(a);
                ...
                var o = i && E(t, w),
                    n = m(t).data(w, l ? -1 : 1);
                if (o) return void u();
                r && "IMG" === t.tagName && !t.src && (t.src = r), n[p] = d({}, s), X("init", n), T.push(n), u()
            }
        })
    }, m(e).ready(function() {
        X("start", a), a.on(b.updateEvent, u).on(b.forceEvent, f), m(e).on(b.updateEvent, u), b.autoInit && (a.on(b.loadEvent, s), s())
    })
}(window.jQuery || window.Zepto || window.$, window, document),
function(l) {
    var o = l.lazyLoadXT;
    o.selector += ",video,iframe[data-src],embed[data-src]", o.videoPoster = "data-poster", l(document).on("lazyshow", "video", function(e, t) {
        ...
        t.attr("poster", t.attr(o.videoPoster)), t.children("source,track").each(function(e, t) {
            var o = l(t),
                n = r ? a(o) : o.attr(a);
            n && (o.attr("src", n), i = !0)
        }), i && void 0 !== l(this).attr("preload") && "none" != l(this).attr("preload") && this.load(), l(this).removeClass("lazy-hidden")
    }), l(document).on("lazyshow", "embed", function(e, t) {
        l(this).removeClass("lazy-hidden")
    })
}(window.jQuery || window.Zepto || window.$);; /* Lazy Load XT 1.1.0 | MIT License */
! function(t, r, e, s) {
...
jQuery.lazyLoadXT.srcsetExtended = !1;
...
var ElementorProFrontendConfig = {
    ...
    "nonce": "ccf8401669",
    "urls": {
        "assets": "https:\/\/allvaleesquadrias.com\/wp-content\/plugins\/pro-elements\/assets\/",
        "rest": "https:\/\/allvaleesquadrias.com\/wp-json\/"
    },
    "settings": {
        "lazy_load_background_images": !0
    },
    "popup": {
        "hasPopUps": !1
    },
    ...
    "lottie": {
        "defaultAnimationUrl": "https:\/\/allvaleesquadrias.com\/wp-content\/plugins\/pro-elements\/modules\/lottie\/assets\/animations\/default.json"
    }
}; /*! elementor-pro - v3.30.0 - 01-07-2025 */
